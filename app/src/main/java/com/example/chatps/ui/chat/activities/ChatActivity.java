...
import com.example.chatps.ui.chat.adapters.ChatAdapter;
import com.example.chatps.databinding.ActivityChatBinding;
import com.example.chatps.ui.chat.models.ChatMessage;
import com.example.chatps.ui.chat.models.User;
import com.example.chatps.ui.chat.network.ApiClient;
import com.example.chatps.ui.chat.network.ApiService;
                ...
                if (response.isSuccessful()) {
                    try {
                        if (response.body() != null) {
                            ...
                            JSONArray results = responseJson.getJSONArray("resultados");
                            if (responseJson.getInt("falla") == 1) {
