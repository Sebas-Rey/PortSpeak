...
import com.example.chatps.databinding.ActivityMainChatBinding;
import com.example.chatps.ui.MainResidenteActivity;
import com.example.chatps.ui.chat.adapters.RecentConversationsAdapter;
import com.example.chatps.ui.chat.listeners.ConversionListener;
...
public class MainChatActivity extends BaseActivity implements ConversionListener {
    ...
    private void updateToken(String token) {
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token)
                .addOnFailureListener(e -> showToast("No se ha podido actualizar el Token"));
    }
